  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-10 px-4 bg-slate-950/60">
      <div className="w-full max-w-md space-y-6 animate-fade-in-up">
        ...
        {/* Safety briefing */}
        <div className="bg-sky-500/10 backdrop-blur-md rounded-2xl border-l-4 border-sky-400 p-5 shadow-card-dipped flex gap-3 accent-glow">
        ...
        {questions.length > 0 && (
          <div className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised p-6 accent-glow aurora-bg">
