  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20 text-slate-800">
        <h1 className="text-2xl font-bold mb-2">The Real Cost of a Failed Safety Audit</h1>
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          <h2 className="text-lg font-semibold mt-6">The numbers do not lie</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6">The hidden costs</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6">The easiest violation to avoid</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6">How to bulletproof your paperwork</h2>
          <p>
          ...
          <p>
            <strong>SiteSafe</strong> was built exactly for this — a digital visitor log that is as simple as paper, but actually reliable. It takes 30 seconds to set up, runs on any tablet or phone, and gives you instant audit-ready exports.
          </p>
