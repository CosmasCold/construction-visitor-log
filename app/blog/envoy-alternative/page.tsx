...
export const metadata: Metadata = {
  ...
  description:
    "Looking for an Envoy alternative? Compare 7 top visitor management systems with transparent pricing — SiteSafe starts at $49/mo for 20 sites.",
  openGraph: {
    title: "Top 7 Envoy Alternatives for Multi-Site Visitor Management (2026)",
    description:
      "Looking for an Envoy alternative? Compare 7 top visitor management systems with transparent pricing — SiteSafe starts at $49/mo for 20 sites.",
...
const alternatives = [
  ...
  },
  {
    ...
    whyAlternative:
      "SwipedOn offers a simple iPad-based check-in experience. It’s a solid option if you have one office and don’t need multi-site visibility.",
    catch:
  ...
  },
  {
    name: "Paper Logs",
    rank: 7,
    tagline: "The “Free” Option",
    pricing: "~$20/year for clipboards",
    bestFor: "No one",
    whyAlternative: "It’s cheap. That’s the only advantage.",
    catch:
      ...
      <article className="max-w-4xl mx-auto space-y-12 text-white">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            ...
            you’re a small or mid-sized business, you’ve probably hit a wall:
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="glass-card p-6 space-y-2">
              ...
              <p className="text-sm text-slate-400">
                Envoy charges per location. If you have 5 sites, you’re paying 5×
            ...
            <div className="glass-card p-6 space-y-2">
              ...
              <p className="text-sm text-slate-400">
                Want watchlist screening? That’s a paid add-on. Want emergency
            ...
            <div className="glass-card p-6 space-y-2">
              ...
              <p className="text-sm text-slate-400">
                Envoy requires a 45-minute sales demo before you can see pricing
                or try the product. That’s a lot of friction for a busy facility
                manager.
              </p>
              <p className="text-sm text-sky-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                a: "Switching is straightforward. You can export your existing visitor records from Envoy as a CSV for your own archive, then start fresh with SiteSafe. There’s no complex data migration — just set up your sites, add your hosts, and you’re ready to go.",
              },
              {
        ...
        <section className="glass-card p-8 text-center space-y-4">
          ...
          <p className="text-slate-300 max-w-2xl mx-auto">
            If you’re a small or mid-sized business tired of Envoy’s per-site fees,
