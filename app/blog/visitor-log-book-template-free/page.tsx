...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Free Visitor Log Book Template (PDF) — And Why Paper Logs Fail",
    description: "Download our free template. Then see why 10 minutes of setup beats paper forever.",
    images: ["/blog/visitor-log-template-og.png"],
  },
};
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-16 pt-8 border-t border-white/5">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/blog/osha-visitor-log-requirements" className="group rounded-xl border border-white/5 bg-white/[0.03] p-5 hover:bg-white/[0.06] transition-all">
            ...
            <Link href="/blog/visitor-management-roi-calculator" className="group rounded-xl border border-white/5 bg-white/[0.03] p-5 hover:bg-white/[0.06] transition-all">
              <h4 className="font-semibold text-white text-sm mb-1 group-hover:text-sky-400 transition-colors">
