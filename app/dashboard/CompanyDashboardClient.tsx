      ...
      <div className="max-w-6xl mx-auto space-y-6 animate-fade-in-up">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 p-4 flex items-center gap-3 accent-glow aurora-bg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Date filter */}
          <div className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised p-4 flex flex-wrap items-end gap-3 accent-glow aurora-bg">
            <div>
          ...
          {/* New Site */}
          <div className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised p-4 accent-glow aurora-bg">
            <button
        ...
        <div id="sites-grid" className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {sites.length === 0 ? (
            ...
            sites.map((site) => (
              <div
                key={site.id}
                className={`relative bg-white/[0.12] backdrop-blur-md rounded-2xl border ${
        ...
        <div
          ...
          className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised p-6 accent-glow aurora-bg"
        >
        ...
        {loading ? (
          ...
          <div className="bg-white/[0.12] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised overflow-x-auto accent-glow aurora-bg">
