  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-24 sm:py-32 sm:px-6 lg:px-8 text-center">
        <div className="bg-white/[0.10] backdrop-blur-xl rounded-3xl border border-white/10 shadow-card-raised p-10 sm:p-14 gradient-border bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 sm:p-8 text-center accent-glow bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg">
      ...
      <div id="features" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {group.items.map((f, idx) => (
                <FadeInSection key={idx} delay={idx * 100}>
                  <div className="bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 flex gap-4 items-start hover:bg-white/[0.08] transition-all duration-300 feature-card-hover">
        ...
        <div className="mt-8 flex justify-center">
          <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 flex gap-4 items-start max-w-md w-full hover:bg-white/[0.08] transition-all duration-300 accent-glow bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {industries.map((industry) => (
              <div
                key={industry.name}
                className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised px-6 py-3 text-sm text-slate-200 font-medium flex items-center gap-2 hover:bg-white/[0.08] hover:-translate-y-0.5 transition-all duration-300"
              >
      ...
      <FadeInSection>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-8 text-center relative accent-glow bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-3xl mx-auto">
          <Link href="/audit" className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 hover:bg-white/[0.08] transition-all duration-300 flex gap-4 items-start group">
            <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-sky-500/20 flex items-center justify-center">
          ...
          <Link href="/roi-calculator" className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 hover:bg-white/[0.08] transition-all duration-300 flex gap-4 items-start group">
            <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-emerald-500/20 flex items-center justify-center">
      ...
      <div className="max-w-2xl mx-auto mb-12 px-4">
        <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-5 text-center">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
        <div className="flex justify-center">
          <Link href="/docs" className="inline-flex items-center gap-2 bg-white/[0.10] backdrop-blur-lg rounded-xl border border-white/5 px-4 py-3 text-sm text-slate-400 hover:text-white transition-colors duration-150">
      ...
      {/* Footer CTA */}
      <div className="bg-white/[0.08] backdrop-blur-sm py-16 border-t border-white/5 accent-glow bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] bg-white/[0.10] aurora-bg">
