  ...
  return (
    <div className="min-h-screen text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 sm:p-8 text-center accent-glow aurora-bg">
      ...
      <div id="features" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {group.items.map((f, idx) => (
                <FadeInSection key={idx} delay={idx * 100}>
                  <div className="aurora-bg backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 flex gap-4 items-start hover:bg-white/[0.08] transition-all duration-300 feature-card-hover">
        ...
        <div className="mt-8 flex justify-center">
          <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-6 flex gap-4 items-start max-w-md w-full hover:bg-white/[0.08] transition-all duration-300 accent-glow aurora-bg">
      ...
      <FadeInSection>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="bg-white/[0.12] backdrop-blur-lg rounded-2xl border border-white/10 shadow-card-raised p-8 text-center relative accent-glow aurora-bg">
