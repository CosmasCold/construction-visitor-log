  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto space-y-8">
        {/* Header – optimized for "visitor log self‑audit" */}
        <div className="bg-white/[0.06] backdrop-blur-md rounded-2xl border border-white/10 shadow-card-raised p-8 text-center">
          ...
          <p className="text-sm text-slate-400 max-w-md mx-auto">
            Take this 10‑question visitor log self‑audit to see if your current
            sign‑in process would survive a safety inspection. Takes 60 seconds,
            no sign‑up required.
          </p>
        </div>
