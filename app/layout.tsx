...
export const metadata: Metadata = {
  ...
  description:
    "Smart visitor management for mid-size businesses with multiple sites. QR check‑in, real‑time dashboard, audit‑ready exports.",
  openGraph: {
    title: "SiteSafe – Smart Visitor Management",
    description:
      "Smart visitor management for mid-size businesses with multiple sites.",
    type: "website",
