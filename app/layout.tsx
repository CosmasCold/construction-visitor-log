  ...
  return (
    <html lang="en">
      ...
      <body
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(15,23,42,0.72), rgba(15,23,42,0.78)), url('https://images.unsplash.com/photo-1521737603724-dbb665a0b1f7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')`,
