...
export const metadata: Metadata = {
  ...
  description: "How SiteSafe collects, uses, and protects your data.",
};
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white/[0.06] backdrop-blur-md rounded-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.12)] p-8 text-white">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-slate-200">
          ...
          <section>
            <h2 className="font-semibold text-base text-white mb-2">6. Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-base text-white mb-2">7. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-base text-white mb-2">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-base text-white mb-2">9. Contact Us</h2>
            <p>
