...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspValue = [
      "default-src 'self'",
      `script-src 'self' 'unsafe-inline' ${isDev ? "'unsafe-eval'" : ""} https://client.crisp.chat https://*.sf-syn.com https://www.youtube.com https://www.youtube-nocookie.com https://www.youtube.com/iframe_api https://s.ytimg.com`,
